  ...
  return (
    <section id="home" className="relative h-[calc(100vh-4rem)] w-full flex items-center justify-center">
            ...
            <div className="relative z-10 container mx-auto px-4 text-center text-foreground">
                <h1 className="text-4xl font-extrabold tracking-tight font-headline sm:text-5xl md:text-6xl lg:text-7xl pb-28 text-shadow-white-2xl">
                    Your Smooth Move Starts Here
                </h1>
                <p className="mt-6 max-w-3xl font-bold mx-auto text-lg md:text-2xl pt-28 text-shadow-white-2xl">
