...
const services = [
  {
    ...
    description: "Efficient and safe moving services within your city. We handle your belongings with utmost care.",
  },
  {
    icon: <Globe className="h-10 w-10 text-accent" aria-hidden="true" />,
    title: "Long-Distance Removals",
    description: "Relocating to a new state or across the country? Our long-distance moving services are here for you.",
  },
  {
    icon: <Package className="h-10 w-10 text-accent" aria-hidden="true" />,
    title: "Packing Services",
    description: "Save time and effort with our professional packing and unpacking services. We use high-quality materials.",
  },
];
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              We offer a complete range of moving services to make your relocation seamless and stress-free.
            </p>
          </div>
        </div>
